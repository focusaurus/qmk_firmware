...
[OSX] = LAYOUT(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  // Row C Left
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TG(OSX),
  // Row C Right
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  // Row D Left
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
...
[KEEBNAV] = LAYOUT(
  ...
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  // Row B Left
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_MODE_FORWARD,
  // Row B Right
  RGB_VAI, KC_PGUP, KC_BSPC, KC_SPC, KC_DEL, KC_TRNS, KC_TRNS,
  // Row C Left
  RGB_MOD, RGB_MOD, RGB_MOD, RGB_MOD, RGB_MOD, RGB_MOD, RGB_TOG,
  // Row C Right
  RGB_SAI, KC_ENT, KC_LEFT, KC_UP, KC_RIGHT, KC_TAB, KC_TRNS,
  // Row D Left
  KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC, KC_TRNS, KC_TRNS, RGB_MODE_REVERSE,
  // Row D Right
  RGB_VAD, KC_PGDN, KC_HOME, KC_DOWN, KC_END, KC_TRNS, KC_TRNS,
     KC_TRNS,                     KC_TRNS,
      KC_TRNS,               KC_TRNS,
         KC_TRNS,         KC_TRNS,
            KC_TRNS,   KC_TRNS,
